        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header" style="padding: 10px;">
                <h2 class="card-title danger" style="display: inline-block;padding-top:10px;">Edit Content</h3>
            ...
            <div class="card-body m-3">
              <form action="{{route('admin.content.update',$c->id)}}" method="post" class="form" enctype="multipart/form-data" id="form">
                  @csrf
                  @method('put')
                  <div class="form-body">
                      <div class="row">
                          ...
                          <div class="col-md-12 col-12">
                            <div class="form-group">
                                <label>Author</label>
                                <div class="position-relative has-icon-right">
                                    <input type="text" class="form-control" name="author" value="{{$c->author}}" required>
                                    <div class="form-control-position">
                          ...
                          <div class="col-md-12 col-12">
                              <div class="form-group">
                                  ...
                                  <div class="position-relative has-icon-right">
                                    ...
                                    <div id="editor" style="height: 300px;">{!! $c->content !!}</div>
                        ...
                        <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="date" class="form-control pickadate-selectors" value="{{$c->date}}">
...
<script src="{{ asset('app-assets/vendors/js/pickadate/picker.js') }}" type="text/javascript"></script>
    ...
    <script>
        ...
        function loadPic() {
            let titleImg = "{{$c->photos}}";
            let titlePath = "{{asset('uploads/contents/photos/')}}";
            let titlePreload = [];
