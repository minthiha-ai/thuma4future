    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body m-3">
                <form action="{{route('admin.member.update',$m->id)}}" method="post" class="form" enctype="multipart/form-data" id="form">
                    @csrf
                    @method('put')
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Name</label>
                                    <div class="position-relative has-icon-right">
                                        <input type="text" class="form-control" placeholder="Enter your name" name="name" value="{{$m->name}}" required>
                                        <div class="form-control-position">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="dob" class="form-control pickadate-dropdown" value="{{ $m->dob }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="email" class="form-control" placeholder="Enter your email" name="email" value="{{ $m->email }}" required>
                                        <div class="form-control-position">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="text" class="form-control" name="education" placeholder="Enter educational status" value="{{ $m->education }}" required>
                                        <div class="form-control-position">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Job</label>
                                    <div class="position-relative has-icon-right">
                                        <input type="text" class="form-control" placeholder="Enter your job" name="job" value="{{ $m->job }}" required>
                                        <div class="form-control-position">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="text" class="form-control" name="position" placeholder="Enter your position at Thuma Organization" value="{{ $m->position }}" required>
                                        <div class="form-control-position">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-right">
                                        <input type="text" class="form-control" name="description" placeholder="Enter your own quote or favourite quote" value="{{ $m->description }}" required>
                                        <div class="form-control-position">
...
<script src="{{ asset('app-assets/js/pick-a-datetime.js') }}" type="text/javascript"></script>
    ...
    <script>
        ...
        function loadPic() {
            let titleImg = "{{$m->photo}}";
            let titlePath = "{{asset('uploads/members/photos/')}}";
            let titlePreload = [];
